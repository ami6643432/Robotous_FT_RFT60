...
class dynamixtest:
	...
	def __init__(self,id,kp,ki,kd,mode):
	...
	def init_motor_connection(self):
		...
		if dxl_comm_result != COMM_SUCCESS:
			...
			print("DYNAMIXEL "+ str(self.DXL_ID) +" has been successfully connected")
...
if __name__ == '__main__':
	#                (ID,KP  ,KI  ,KD  ,MODE)
	obj = dynamixtest(0 ,0.0 ,0.0 ,0.0 ,0   )
	#obj1 = dynamixtest(1,0.0,0.0,0.0,0)
	#obj2 = dynamixtest(2,0.0,0.0,0.0,0)
	#obj3 = dynamixtest(3,0.0,0.0,0.0,0)
	r = rospy.Rate(60)
