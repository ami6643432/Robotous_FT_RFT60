...
class dynamixtest:
	...
	def data_set1(self,data):
		...
		self.write_to_motor(self.GOAL_POSITION_ANGLE * self.ratio)
...
if __name__ == '__main__':
	obj1 = dynamixtest(id=1,OPERATING_MODE=3,ratio=1)
	obj2 = dynamixtest(id=2,OPERATING_MODE=3,ratio=1)
	obj3 = dynamixtest(id=3,OPERATING_MODE=4,ratio=1079.73632812)
	r = rospy.Rate(60)
