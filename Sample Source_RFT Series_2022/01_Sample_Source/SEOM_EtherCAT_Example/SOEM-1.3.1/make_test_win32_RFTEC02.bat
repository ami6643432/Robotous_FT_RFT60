...
if EXIST test\win32\RFTEC02_R0\obj goto skip_obj
MKDIR test\win32\RFTEC02_R0\obj
:skip_obj
cl.exe @make\cl_RFTEC02_R0.rsp /errorReport:prompt
link.exe @make\link_RFTEC02_R0.rsp /nologo /errorReport:prompt
