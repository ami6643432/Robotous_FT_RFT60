...
if EXIST test\win32\RFTEC01_R4_TEST\obj goto skip_obj
MKDIR test\win32\RFTEC01_R4_TEST\obj
:skip_obj
cl.exe @make\cl_RFTEC01_R4_TEST.rsp /errorReport:prompt
link.exe @make\link_RFTEC01_R4_TEST.rsp /nologo /errorReport:prompt
